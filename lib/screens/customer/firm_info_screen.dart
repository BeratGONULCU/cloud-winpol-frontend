...
class _FirmaInfoMainScreenState extends State<FirmaInfoMainScreen> {
        ...
        return SizedBox(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(
                width: 320, // width sabit kalsın (istersen dinamik de yaparız)
                child: _branchSidePanel(),
              ),
            ],
          ),
        );
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _input("Firma Ünvanı", _firma!['Firma Ünvan1']),
            _input("Firma Ünvanı 2", _firma!['Firma Ünvan2']),

            Row(
              children: [
                Expanded(
                  child: _input("Vergi Dairesi", _firma!['Vergi Dairesi']),
                ),
                const SizedBox(width: 16),
                Expanded(child: _input("Vergi No", _firma!['Vergi No'])),
              ],
            ),

            _input("T.C. Kimlik", _firma!['T.C. Kimlik']),
            _input("E-Mail", _firma!['E-Mail']),
            _input("Web Adresi", _firma!['Web Adresi']),
            ...
            Align(
              ...
              child: _primaryButton(
                ...
                label: "Düzenle",
                onTap: () {
                  Navigator.pushNamed(context, '/firmaEdit', arguments: _firma);
                },
              ),
            ),
          ],
  ...
  Widget _input(String label, dynamic value) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 14), // biraz sıkı
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            ...
            style: const TextStyle(
              fontSize: 12,
              color: Color(0xFF6B7280), // daha net gri
          ...
          TextField(
            ...
            style: const TextStyle(
              fontSize: 14,
              color: Color(0xFF111827), // net siyah
            ),
            decoration: InputDecoration(
              ...
              contentPadding: const EdgeInsets.symmetric(
                horizontal: 12,
                vertical: 12, // daha kompakt
              ),
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8), // 12 → 8 (KESKİNLİK)
                borderSide: const BorderSide(
                  color: Color(0xFFD1D5DB), // daha net border
                ),
              ),

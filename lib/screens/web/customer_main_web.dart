...
class CustomerMainWebScreen extends StatefulWidget {
  static const String routeName = '/customerMain';
  const CustomerMainWebScreen({super.key});

  @override
  State<CustomerMainWebScreen> createState() => _CustomerMainWebScreenState();
}

class _CustomerMainWebScreenState extends State<CustomerMainWebScreen> {  
